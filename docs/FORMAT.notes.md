...
On the fixtures the tail is entirely in the sample log, `n20021018.2` (120,840 records), where 117 of 289 lives go past three; `040601.6` has 21 lives, all at exactly three. Two to look at: square 137,120 is shot at record 2,486 (2:57.16), takes two unchanged hits in record 2,490, three in 2,494 and falls in 2,498, all logged by player 1, the target of a single angry pill (index 13) that fires two or three times a record; square 129,112 is shot at record 6,636 by player 3, hit once by him at 6,657, then three times by player 1's tank at 7,142–7,150 and flattened by it at 7,170, one shell per record. The count is not kept per machine: in `040601.6` the three unchanged hits of a life are routinely split between the two players (square 134,132, records 7,796, 9,089 and 9,123), and collapsing the hits of one record into one hit only moves the mode to two.
