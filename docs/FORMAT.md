...
- **A quitting player's carried pills drop the same way** around the tank position the quit record itself states, with no events; a ghost's quit, minutes after his last statement, restates a position that is not his tank's, and his pills drop around the last genuine one [E:quit-pills].
